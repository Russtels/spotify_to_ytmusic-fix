spotify_to_ytmusic (Added Support for Deleted/Corruped Songs)
####################
...
⚠️This is a FORK from sigma67 pls make sure to check out the original project(https://github.com/sigma67/spotify_to_ytmusic)⚠️
